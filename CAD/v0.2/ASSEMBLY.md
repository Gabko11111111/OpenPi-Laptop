# Enclosure v0.2 — assembly and exact fasteners
...
The parts fit inside the stated QIDI Q2 270 × 270 × 256 mm volume as geometric envelopes. The widest/deepest lid leaves only 2 mm per side in depth. Any brim, support, skirt, or printer exclusion must fit too. Check this in the slicer; do not assume the printer can use every nominal millimetre.
